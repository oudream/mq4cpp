...
public:
	MyClient() : MessageQueue("MyClient")
	{
		SCHEDULE(this,500);
		itsCounter=0;
		lookup("MyServerA",itsServerA);
		lookup("MyServerB",itsServerB);
	};
...
int main() 
{
	DISPLAY("MQ4CPP example4.cpp")
	DISPLAY("This example shows how to send indirect messages unsing lookup")		
	LOG("!!!!!!! example4.cpp !!!!!!!")
